package src.optAlg.topkMonitoring;
...
public class SnapshotTopkMonitoringOpt {
	...
	public void snapshotTopkMonitor() throws Exception {
		...
		PrefixTreeOpt prefixTree = new PrefixTreeOpt(this);
		...
		timeInfos.add(new InfoHolder(51, "WindowSize", DummyProperties.WINDOW_SIZE));
		timeInfos.add(new InfoHolder(52, "WindowMode", DummyProperties.windowMode));
		timeInfos.add(new InfoHolder(53, "carryOverDuraion", carryOverDuraion));
		timeInfos.add(new InfoHolder(53, "winMineDuraion", winMineDuraion));
		TimeLogger.LogTime(
				"dis_" + (DummyProperties.windowMode ? "Win" : "Inc") + "_" + DummyProperties.WINDOW_SIZE + ".txt",
				true, timeInfos);
	...
	public SnapshotTopkMonitoringOpt(String[] args) throws Exception {
	...
	public SnapshotTopkMonitoringOpt(String focusSetPath, int maxHops, int maxEdges, String dataGraphPath,
	...
	public static void main(String[] args) throws Exception {
		SnapshotTopkMonitoringOpt snapshotTopkMonitoring = new SnapshotTopkMonitoringOpt(args);
