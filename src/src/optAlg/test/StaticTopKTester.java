...
// }
//
// if (allFocusLinesPath == null || dataGraphPath == null || k == 0 ||
// maxAllowedHops == 0
// || maxAllowedEdges == 0) {
// throw new Exception("input parameters: focusSetPath, dataGraphPath, k,
// maxAllowedHops, maxAllowedEdges");
// } else {
// System.out.println("-allFocusLinesPath " + allFocusLinesPath + ",
// -dataGraphPath:" + dataGraphPath
// + ", -k " + k + ", -maxAllowedHops:" + maxAllowedHops + ", -maxAllowedEdges "
// + maxAllowedEdges);
// }
...
// System.out.println(
// "focus was " + line + ", h:" + h + " , e:" + e + " , k:" + k + ", threshold:"
// + threshold);
//
