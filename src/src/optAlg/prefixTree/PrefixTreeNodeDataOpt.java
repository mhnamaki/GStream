...
public class PrefixTreeNodeDataOpt implements IPrefixTreeNodeData {
	...
	public MatchNodesOpt matchNodes = null;
	...
	// usage: for root node;
	public PrefixTreeNodeDataOpt(Set<String> set) {
	 ...
	 */
	public PrefixTreeNodeDataOpt(PatternNode sourceAbstractPatternNode, HashSet<Integer> srcDataGraphPatternNodes,
		...
		matchNodes = new MatchNodesOpt(dataGraphNodeOfAbsPttnNode, abstractPatternNodeOfNeo4jNode);
	 ...
	 */
	public PrefixTreeNodeDataOpt(ListenableDirectedGraph<PatternNode, DefaultLabeledEdge> newAbsPattern,
		...
		if (matchNodes == null) {
			...
			this.matchNodes = new MatchNodesOpt(dataGraphMatchNodeOfAbsPNode, patternNodeOfNeo4jNode);
		}
	...
	private boolean twoPatternNodesAreSame(PatternNode unexpandedPatternNode,
			...
			PrefixTreeNodeDataOpt prefixTreeNodeData) {
