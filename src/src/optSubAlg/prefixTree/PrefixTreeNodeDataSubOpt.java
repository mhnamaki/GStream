package src.optSubAlg.prefixTree;
...
public class PrefixTreeNodeDataSubOpt implements IPrefixTreeNodeData {
	...
	public MatchNodesSubOpt matchNodes = null;
	...
	// usage: for root node;
	public PrefixTreeNodeDataSubOpt(Set<String> set) {
	 ...
	 */
	public PrefixTreeNodeDataSubOpt(PatternNode sourceAbstractPatternNode, HashSet<Integer> srcDataGraphPatternNodes,
		...
		matchNodes = new MatchNodesSubOpt(dataGraphNodeOfAbsPttnNode, abstractPatternNodeOfNeo4jNode);
	 ...
	 */
	public PrefixTreeNodeDataSubOpt(ListenableDirectedGraph<PatternNode, DefaultLabeledEdge> newAbsPattern,
			...
			Integer destDataGraphPatternNodeId, Integer patternPrefixTreeNodeIndex, String relationshipType,
		...
		if (matchNodes == null) {
			...
			this.matchNodes = new MatchNodesSubOpt(dataGraphMatchNodeOfAbsPNode, patternNodeOfNeo4jNode);
		}
		...
		this.matchNodes.patternNodeOfNeo4jNode.putIfAbsent(destDataGraphPatternNodeId, new HashSet<PatternNode>());
		...
		SourceRelDestTypeTriple key = new SourceRelDestTypeTriple(srcAbstractPatternNode.getType(),
				destAbstractPatternNode.getType(), relationshipType);
	...
	public void addNewMatch(PatternNode destAbstractPatternNode, Integer destDataGraphPatternNodeId, Indexer indexer) {
		...
		indexer.candidateSetOfAPatternNode.get(destAbstractPatternNode).add(destDataGraphPatternNodeId);
	}
	...
	private boolean twoPatternNodesAreSame(PatternNode unexpandedPatternNode,
			...
			PrefixTreeNodeDataSubOpt prefixTreeNodeData) {
