...
public class Configuration {
	...
	public Configuration(String focuses, int maxAllowedHops, int maxAllowedEdges, String dataGraphName, int k,
		...
		if (!datasetInfos.containsKey(dataGraphName)) {
			Configuration.returnErrorMessageToWeb("the dataset is not valid!");
			return;
		}
	...
	public static void returnErrorMessageToWeb(Object obj) {
		...
		errorMessage = "Error! " + obj.toString();
		hasError = true;
	}
