...
public class VF2State {
	...
	public VF2State(GraphDatabaseService modelGraph, DirectedGraph<PatternNode, DefaultLabeledEdge> patternGraph2,
			BiMap<PatternNode, Integer> patternGraphIdMap, Indexer indexer) {
		...
		modelSize = indexer.maxNodeId;
		// for (Node n : modelGraph.getAllNodes()) {
		// modelSize++;
		// }

		modelSize = (int) (modelSize * 1.002);
	...
	public void match(int n, int m) {
		...
		// }
		// }
		for (Integer startNodeId : indexer.dataGraphNodeInfos.get(n).prevNodeIds) {
		...
		// }
		// }
		for (Integer endNodeId : indexer.dataGraphNodeInfos.get(n).nextNodeIds) {
