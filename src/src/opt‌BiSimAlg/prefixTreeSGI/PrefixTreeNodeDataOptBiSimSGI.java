...
public class PrefixTreeNodeDataOptBiSimSGI implements IPrefixTreeNodeData {
	...
	public MatchNodesOptBiSimSGI matchNodes = null;
	...
	// usage: for root node;
	public PrefixTreeNodeDataOptBiSimSGI(Set<String> set) {
	 ...
	 */
	public PrefixTreeNodeDataOptBiSimSGI(PatternNode sourceAbstractPatternNode, HashSet<Integer> srcDataGraphPatternNodes,
		...
		matchNodes = new MatchNodesOptBiSimSGI(dataGraphNodeOfAbsPttnNode, abstractPatternNodeOfNeo4jNode);
	 ...
	 */
	public PrefixTreeNodeDataOptBiSimSGI(ListenableDirectedGraph<PatternNode, DefaultLabeledEdge> newAbsPattern,
		...
		if (matchNodes == null) {
			...
			this.matchNodes = new MatchNodesOptBiSimSGI(dataGraphMatchNodeOfAbsPNode, patternNodeOfNeo4jNode);
		}
	...
	private boolean twoPatternNodesAreSame(PatternNode unexpandedPatternNode,
			...
			PrefixTreeNodeDataOptBiSimSGI prefixTreeNodeData) {
