...
public class RegularExperimenterForAllV2 {
					...
					for (double t : thresholds) {
						for (int k : ks) {
							...
							for (int n = 0; n < numberOfIntervals; n++) {
								...
								// StaticGraphTopKBiSimOpt
								// staticGraphTopKBiSimOpt = new
								// StaticGraphTopKBiSimOpt(
								// "focusSet.txt", h, e, dataGraphPath,
								// debugMode, k, t,
								// DummyProperties.windowMode,
								// DummyProperties.WINDOW_SIZE);
								// staticGraphTopKBiSimOpt.findStaticTopK();
								//
								// System.out.println("Static Bi Sim Opt: exp "
								// + exp + " focus was " + line + ", h:"
								// + h + " , e:" + e + " , k:" + k + ",
								// threshold:" + t + " in interval: "
								// + n);
								//
								...
								// }
								//
								// SnapshotTopkMonitoringOptBiSim
								// snapshotTopkMonitoringOptBiSim = new
								// SnapshotTopkMonitoringOptBiSim(
								...
								// numberOfSnapshots,
								// dateFormat, numberOfIgnoranceInitEdges, 100,
								// DummyProperties.windowMode,
								// DummyProperties.WINDOW_SIZE);
								//
								// snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();
								//
								// System.out.println("IncBiSim100 exp " + exp +
								// " focus was " + line + ", h:" + h
								// + " , e:" + e + " , k:" + k + ", threshold:"
								// + t + " in interval: " + n);
								//
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									SnapshotTopkMonitoringOptBiSim snapshotTopkMonitoringOptBiSim = new SnapshotTopkMonitoringOptBiSim(
											...
											dateFormat, numberOfIgnoranceInitEdges, (edgeStreamCacheCapacity / 10),
											DummyProperties.windowMode, DummyProperties.WINDOW_SIZE);

									snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();

									System.out.println("IncBiSim_1,000: exp " + exp + " focus was " + line + ", h:" + h
											+ " , e:" + e + " , k:" + k + ", threshold:" + t + " in interval: " + n);
