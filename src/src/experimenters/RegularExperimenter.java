...
public class RegularExperimenter {
						...
						for (int n = 0; n < numberOfIntervals; n++) {
							...
							for (int exp = 0; exp < numberOfSameExperiments; exp++) {
								...
								SnapshotTopkMonitoring snapshotTopkMonitoring = new SnapshotTopkMonitoring(
										...
										numberOfIgnoranceInitEdges, DummyProperties.windowMode,
										DummyProperties.WINDOW_SIZE);

								snapshotTopkMonitoring.snapshotTopkMonitor();

								System.out.println("Inc: exp " + exp + " focus was " + line + ", h:" + h + " , e:" + e
										+ " , k:" + k + ", threshold:" + t + " in interval: " + n);
							...
							for (int exp = 0; exp < numberOfSameExperiments; exp++) {
								...
								SnapshotTopkMonitoringOpt snapshotTopkMonitoringOpt = new SnapshotTopkMonitoringOpt(
										"focusSet.txt", h, e, newDGPath.toString(), debugMode, k, t, deltaEFileOrFiles,
										numberOfTransactionInASnapshot, numberOfSnapshots, dateFormat,
