...
public class RegularExperimenterForWinIncDisn {
							...
							for (int n = 0; n < numberOfIntervals; n++) {
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									SnapshotTopkMonitoringOptBiSim snapshotTopkMonitoringOptBiSim = new SnapshotTopkMonitoringOptBiSim(
											...
											dateFormat, numberOfIgnoranceInitEdges, 100, windowMode,
											windowSizeLInt);

									
									snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();

									System.out.println("WinDis100: exp " + exp + " focus was " + line + ", h:" + h
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									System.out.println("WinDis1000: exp " + exp + " focus was " + line + ", h:" + h
											+ " , e:" + e + " , k:" + k + ", threshold:" + t + " in interval: " + n);
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									System.out.println("WinDis10000: exp " + exp + " focus was " + line + ", h:" + h
											+ " , e:" + e + " , k:" + k + ", threshold:" + t + " in interval: " + n);
