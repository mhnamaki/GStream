...
public class RegularExperimenterForIncs {
	...
	private static double threshold = 0.05; // percent of focus node candidates
	...
	public static void main(String[] args) throws Exception {
		...
		Dummy.DummyProperties.bigDataTestMode =false;
...
//									String nextForBatchPath = getNextDataGraphPath(dataGraphPath, streamMode, interval,
//											n + 1);
//									System.out.println("nextForBatchPath: " + nextForBatchPath);
//									StaticGraphTopKBiSimOpt staticGraphTopKBiSimOpt = new StaticGraphTopKBiSimOpt(
//											"focusSet.txt", h, e, nextForBatchPath, debugMode, k, t,
...
//											+ h + " , e:" + e + " , k:" + k + ",threshold:" + t + " in interval: " + n);
//
...
//								}
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									SnapshotTopkMonitoringOptBiSim snapshotTopkMonitoringOptBiSim = new SnapshotTopkMonitoringOptBiSim(
											...
											dateFormat, numberOfIgnoranceInitEdges, 1, DummyProperties.windowMode,
											DummyProperties.WINDOW_SIZE);

									snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();

									System.out.println("IncBiSim_1: exp " + exp + " focus was " + line + ", h:" + h
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									SnapshotTopkMonitoringOptBiSim snapshotTopkMonitoringOptBiSim = new SnapshotTopkMonitoringOptBiSim(
											"focusSet.txt", h, e, newDGPath.toString(), debugMode, k, t,
											deltaEFileOrFiles, numberOfTransactionInASnapshot, numberOfSnapshots,
											dateFormat, numberOfIgnoranceInitEdges, 10, DummyProperties.windowMode,
											DummyProperties.WINDOW_SIZE);

									snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();

									System.out.println("IncBiSim_10: exp " + exp + " focus was " + line + ", h:" + h
											+ " , e:" + e + " , k:" + k + ", threshold:" + t + " in interval: " + n);
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									SnapshotTopkMonitoringOptBiSim snapshotTopkMonitoringOptBiSim = new SnapshotTopkMonitoringOptBiSim(
											"focusSet.txt", h, e, newDGPath.toString(), debugMode, k, t,
											deltaEFileOrFiles, numberOfTransactionInASnapshot, numberOfSnapshots,
											dateFormat, numberOfIgnoranceInitEdges, 100, DummyProperties.windowMode,
											DummyProperties.WINDOW_SIZE);

									snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();

									System.out.println("IncBiSim_100: exp " + exp + " focus was " + line + ", h:" + h
											+ " , e:" + e + " , k:" + k + ", threshold:" + t + " in interval: " + n);
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									SnapshotTopkMonitoringOptBiSim snapshotTopkMonitoringOptBiSim = new SnapshotTopkMonitoringOptBiSim(
											"focusSet.txt", h, e, newDGPath.toString(), debugMode, k, t,
											deltaEFileOrFiles, numberOfTransactionInASnapshot, numberOfSnapshots,
											dateFormat, numberOfIgnoranceInitEdges, 1000, DummyProperties.windowMode,
											DummyProperties.WINDOW_SIZE);

									snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();

									System.out.println("IncBiSim_1000: exp " + exp + " focus was " + line + ", h:" + h
											+ " , e:" + e + " , k:" + k + ", threshold:" + t + " in interval: " + n);
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									SnapshotTopkMonitoringOptBiSim snapshotTopkMonitoringOptBiSim = new SnapshotTopkMonitoringOptBiSim(
											"focusSet.txt", h, e, newDGPath.toString(), debugMode, k, t,
											deltaEFileOrFiles, numberOfTransactionInASnapshot, numberOfSnapshots,
											dateFormat, numberOfIgnoranceInitEdges, 10000, DummyProperties.windowMode,
											DummyProperties.WINDOW_SIZE);

									snapshotTopkMonitoringOptBiSim.snapshotTopkMonitor();

									System.out.println("IncBiSim_10,000: exp " + exp + " focus was " + line + ", h:" + h
											+ " , e:" + e + " , k:" + k + ", threshold:" + t + " in interval: " + n);
