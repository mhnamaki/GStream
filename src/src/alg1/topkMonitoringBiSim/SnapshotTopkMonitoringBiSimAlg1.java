package src.alg1.topkMonitoringBiSim;
...
import src.alg1.prefixTreeBiSim.PrefixTreeAlg1BiSim;
...
public class SnapshotTopkMonitoringBiSimAlg1 {
	...
	public PrefixTreeAlg1BiSim prefixTree;
	...
	public void snapshotTopkMonitor() throws Exception {
		...
		prefixTree = new PrefixTreeAlg1BiSim(this);
			...
			if (nextStreamEdge.isAdded()) {
				...
				for (int p = 0; p < affectedPatterns.size(); p++) {
					...
					!newCreatedOrTouchedPTNodes
						...
						prefixTree.expandForNewInsertedEdge(srcNode, srcNodeId, srcLabel, destNode, destNodeId,
		...
		timeInfos.add(new InfoHolder(37, "Iso Checking Time G0", isoCheckingTimeG0));
		timeInfos.add(new InfoHolder(38, "Number Of Iso Checking Request G0", numberOfIsoCheckingRequestG0));
		timeInfos.add(new InfoHolder(38, "Number Of Real Iso Checking G0", numberOfRealIsoCheckingG0));
		timeInfos.add(new InfoHolder(39, "Creation Of New PrefixTree Node G0", newPrefixTreeGenerationG0));
		timeInfos.add(new InfoHolder(40, "Num. of support computations G0", numberOfSupportComputationsG0));
		timeInfos.add(new InfoHolder(41, "Support computational time G0", computaionalSupportTimeG0));

		timeInfos.add(new InfoHolder(42, "Iso Checking Time Inc", prefixTree.getDurationOfIsoChecking()));
		timeInfos.add(
				new InfoHolder(43, "Number Of Iso Checking Request Inc", prefixTree.getNumberOfIsoCheckingRequest()));
		timeInfos.add(new InfoHolder(43, "Number Of Real Iso Checking Inc", prefixTree.getNumberOfRealIsoChecking()));
		timeInfos.add(new InfoHolder(44, "Creation Of New PrefixTree Node Inc",
				prefixTree.getDurationOfNewPrefixTreeGeneration()));
		timeInfos.add(new InfoHolder(45, "Num. of support computations Inc", prefixTree.getNumberOfComputeSupport()));
		timeInfos.add(new InfoHolder(46, "Support computational time Inc", prefixTree.getDurationOfComputeSupport()));
		...
		TimeLogger.LogTime(
				"disnBiSim2_" + (DummyProperties.windowMode ? "Win" : "Inc") + "_" + DummyProperties.WINDOW_SIZE + ".txt",
				true, timeInfos);
	...
	public SnapshotTopkMonitoringBiSimAlg1(String[] args) throws Exception {
	...
	public SnapshotTopkMonitoringBiSimAlg1(String focusSetPath, int maxHops, int maxEdges, String dataGraphPath,
	...
	public static void main(String[] args) throws Exception {
		SnapshotTopkMonitoringBiSimAlg1 snapshotTopkMonitoring = new SnapshotTopkMonitoringBiSimAlg1(args);
	...
	private StreamEdge handlingDataStream(StreamEdge nextStreamEdge, PrefixTreeAlg1BiSim prefixTree, Node srcNode,
