...
public class PrefixTreeNodeDataAlg1 implements IPrefixTreeNodeData {
	...
	// usage: for root node;
	public PrefixTreeNodeDataAlg1(Set<String> set) {
	 ...
	 */
	public PrefixTreeNodeDataAlg1(PatternNode sourceAbstractPatternNode, HashSet<Integer> srcDataGraphPatternNodes,
	 ...
	 * @param freshSource
	 */
	public PrefixTreeNodeDataAlg1(ListenableDirectedGraph<PatternNode, DefaultLabeledEdge> newAbsPattern,
			...
			HashSet<Integer> newNodeIds, Integer patternPrefixTreeNodeIndex, String relationshipType,
	...
	private boolean twoPatternNodesAreSame(PatternNode unexpandedPatternNode,
			...
			PrefixTreeNodeDataAlg1 prefixTreeNodeData) {
