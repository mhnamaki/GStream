...
public class StaticGraphTopKBitMap {
	...
	public StaticGraphTopKBitMap(String[] args) throws Exception {
	...
	public StaticGraphTopKBitMap(String focusSetPath, int maxHops, int maxEdges, String dataGraphPath,
	...
	public void findStaticTopK() {
		...
		try (Transaction tx1 = dataGraph.beginTx()) {
			...
			// init prefixTree
			prefixTree = new PrefixTreeBitMap(focusSetPath, maxAllowedHops, maxAllowedEdges, dataGraph, debugMode,
	...
	public static void main(String[] args) throws Exception {
		StaticGraphTopKBitMap staticGraphTopK = new StaticGraphTopKBitMap(args);
